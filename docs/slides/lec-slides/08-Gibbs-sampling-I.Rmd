...
<!-- To see how the chain actually evolves with an overlay on the true density, consider using this code: -->
<!-- ```{r eval=F} -->
<!-- rho <- #set correlation -->
<!-- Sigma <- matrix(c(1,rho,rho,1),ncol=2) -->
<!-- Mu <- c(0,0) -->
...
<!-- thetamat <- matrix(0,nrow=S,ncol=2) -->
<!-- theta <- c(10,10) -->
<!-- points(x=theta[1],y=theta[2],col="red3",pch=17) -->
<!-- for (s in 1:S) { -->
<!--   theta[1] <- rnorm(1,rho*theta[2],sqrt(1-rho^2)) -->
<!--   theta[2] <- rnorm(1,rho*theta[1],sqrt(1-rho^2)) -->
<!--   sampmat[s,] <- theta -->
<!--   points(x=theta[1],y=theta[2],col="blue4",pch=16) -->
<!--   Sys.sleep(0.1) -->
<!-- } -->
<!-- ``` -->
