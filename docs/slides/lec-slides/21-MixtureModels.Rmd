...
& = \sum_{k=1}^K \lambda_k \cdot \psi_{z_i,d}, \\
\end{split}
$$
]
]
...
$$
\begin{split}
L\left[Y = (y_1, \ldots, y_n) | Z = (z_1, \ldots, z_n), \boldsymbol{\psi}, \boldsymbol{\mu}, \sigma^2 \right] & = \prod_{i=1}^n  p\left(y_i | z_i, \mu_{z_i}, \sigma^2 \right)\\
\\
