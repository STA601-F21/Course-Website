---
title: "STA 602L Lab 4: Prior selection and model reparameterization"
...
For this lab, you will need a few different stan files. Download all of them here:
  ...
  + https://sta-360-602l-su20.github.io/Course-Website/labs/lab-04-cauchy_prior.stan;
  + https://sta-360-602l-su20.github.io/Course-Website/labs/lab-04-flat_prior.stan;
  + https://sta-360-602l-su20.github.io/Course-Website/labs/lab-04-log_odds.stan;
  + https://sta-360-602l-su20.github.io/Course-Website/labs/lab-04-normal_prior.stan;
  + https://sta-360-602l-su20.github.io/Course-Website/labs/lab-04-prob.stan; and
  + https://sta-360-602l-su20.github.io/Course-Website/labs/lab-04-unif_prior.stan.
...
One possible choice of prior is a flat prior for $\alpha$ and $\beta$. That is, $p(\alpha) \propto 1$ and $p(\beta) \propto 1$. Let's look at how our posterior beliefs about $\alpha$ and $\beta$ (especially $\alpha$) act under these priors.
...
8. Is this prior proper? Does it result in a proper posterior? If so, under which conditions?
...
9. If we set a uniform prior for $\pi$, what is the induced prior on $\theta = \frac{\pi}{(1+\pi)}$? Is this prior proper?
