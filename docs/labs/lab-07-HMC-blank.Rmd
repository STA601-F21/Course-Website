---
title: "STA 602L Lab 7: Introduction to Hamiltonian Monte Carlo"
...
$$
\begin{aligned}
\boldsymbol{X}_1, \dots, \boldsymbol{X}_n &\sim N \left(\boldsymbol{\theta}, \Sigma \right); \\
...
While you have derived similar conditional normal distributions a few times now, **doing it yet again is very good practice for the midterm**!
