...
- Project proposals are due Tuesday, November 5. 
- Each student will present their project in class either on Tuesday, November 26, Tuesday, December 3 or Thursday, December 5.
- Final project reports are due Tuesday, December 10.
...
The final report should be concise, well written and must not exceed 5 pages. Your report should be written according to the following outline:
...
*You should create a GitHub repository for this final project which must include your R code.*
