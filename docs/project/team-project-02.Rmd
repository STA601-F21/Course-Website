...
- Final reports: 11:59pm, Friday, November 1.
...
Each team MUST collaborate using GitHub. A blank repository has been created for this project with the necessary data files. Follow this link: https://classroom.github.com/g/rfttmYjL to gain access. The first student within each team to accept the invitation will be responsible for adding the team name as well. All other members of the team will be able to join the team once the first person has added the team name. You should only join your MIDS-assigned team. Each individual's contributions should be obvious via the commits history of the team's repository. Feel free to create other folders within the repository as needed but you must add your final reports and presentation slides in the corresponding folders already created for you.


### Presentations

Each team MUST give a brief (6 minute) presentation of their findings in class.

  + The presentation should only cover a brief introduction and your most interesting and important findings.
  + Create your presentation slides with the time limit in mind. You should consider making between 5 and 7 slides, so that you have approximately one minute to get through each one.
