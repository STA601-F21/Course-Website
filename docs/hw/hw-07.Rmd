---
title: "Homework 7"
date: "Due: 11:59pm, Wednesday, April 8"
output: 
  html_document: 
    css: hw.css
    theme: yeti
...
1. <font color="blue">**Continuation of the swimming data from class.**</font> Recall the problem from class on swimming times. Download the data here: [http://www2.stat.duke.edu/~pdh10/FCBS/Exercises/swim.dat](http://www2.stat.duke.edu/~pdh10/FCBS/Exercises/swim.dat). Alternatively, you can create the data by manually typing in the data from class slides (here: [https://sta-602l-s20.github.io/Course-Website/slides/lec-slides/17-linear-regression.html#70](https://sta-602l-s20.github.io/Course-Website/slides/lec-slides/17-linear-regression.html#70).) into R.
    ...
    + <font color="green">**Part (a):**</font> Using the g-prior with g = n = 6, generate samples/realizations from the prior predictive distribution for a single swimmer over the 12 weeks and create a density plot of the predictive draws (one for each week). Are the values plausible?
...
2. Hoff 9.2. For part (b), you don't need to write your own Gibbs sampler. Just follow our approach from class and use the packages. Be sure to compare your results to the results from part (a).

    <font color="red">*You can find the data file `azdiabetes.dat` mentioned  in the question here: http://www2.stat.duke.edu/~pdh10/FCBS/Exercises/.* </font>
