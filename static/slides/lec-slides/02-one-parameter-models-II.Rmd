...
- Let's take a closer look at properties of these four prior distributions, concentrating on the probability that $\theta_N$.
...
- In all cases, how how many trials would we need, assuming no adverse reactions, to be 95% sure that the new agent is as safe as (or safer than) the old one? (Homework question!)
...
& = {n \choose y} \frac{B\big(a + y,\, b + n-y\big)}{B(a,b)},
\end{aligned}
$$
]
]
...
- It is also often useful to derive posterior predictive distributions for 
