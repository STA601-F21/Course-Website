...
- **Typical survey data:** response vector $\boldsymbol{Y}_i = (Y_{i1},\ldots,Y_{ip})^T$ for each person $i$ in a sample of survey respondents, $i = 1,\ldots, n$. For example, we could have
  + $y_{i1} =$ income
...
knitr::include_graphics("img/GSS_PHoff.png")
```
