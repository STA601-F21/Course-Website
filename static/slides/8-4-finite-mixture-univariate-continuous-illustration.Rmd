...
$$
\begin{split}
\pi[\boldsymbol{\lambda} | \dots ] = \textrm{Dirichlet}\left(a_1 + n_1,\ldots,a_d + n_d\right),\\
\end{split}
$$
]
]
...
# Move to the R script [here](https://sta-360-602l-su20.github.io/Course-Website/slides/Mixtures.R).
